pyramid_vertices = [
    vec3(0.5, -0.5, 0.5),    // 0 1ºQ
    vec3(-0.5, -0.5, 0.5),   // 1 2ºQ 
    vec3(-0.5, -0.5, -0.5),  // 2 3ºQ
    vec3(0.5, -0.5, -0.5),   // 3 4ºQ
    vec3(0.0, 0.5, 0.0),     // 4 Topo
...
function pyramidBuild()
{
    ...
    pyramidAddBase(0,1,2,3,vec3(0.0,-1.0,0.0));
    
    pyramidAddFace(0,1,4,vec3(0.0,-0.5,-1.0));
    pyramidAddFace(1,2,4,vec3(-1.0,-0.5,0.0));
    pyramidAddFace(2,3,4,vec3(0.0,-0-5,1.0));
    pyramidAddFace(3,0,4,vec3(1.0,0.5,0.0));
